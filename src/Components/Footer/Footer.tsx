...
import numberIco from './callIco.svg'
...
const NumberPhone = styled.h3`
  font-size: 16px;
  font-weight: 400;
  padding-left: 28px;
  margin-top: 24px;
  background: url("${numberIco}") left no-repeat;
  @media ${props => props.theme.media.tablet} {
    font-size: 12px;
  }
`
    ...
    return (
        <FooterBody>
            <div className="container">
                <Wrapper>
                    ...
                    <InfoWrapper>
                        <FooterItem>
                            ...
                            <NumberPhone>+7(930)833-38-11</NumberPhone>
                        </FooterItem>
                        <FooterItem>
                            <h4>Мы в соцсетях</h4>
                            <SocialWrapper>
                ...
                <CopyRight>© YouMeal, 2022</CopyRight>
            </div>
        </FooterBody>
    )
}